...
/* Structure of Google's QuickDraw Data uses nested JSON arrays.
 {..."drawing":[[[x,x],[y,y]],[[x,x,x],[y,y,y]]]}  */
...
class QuickDraw {
  ...
  /* A function that updates the mode of the drawing 
  ...
  private void load(int index) {
    ...
    /* load the size and data information of the input index */

    object = parseJSONObject(source[index]);

    /* process each line's JSOB object and isolate the "drawing"
     data from the array */
